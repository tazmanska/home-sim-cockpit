...
{
    partial class AddEditLEDDisplayDeviceDialog
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
        	...
        	this.groupBox1.Text = "Wyświetlacze 7-LED";
        	// 
        	// textBox2
        	// 
        	...
        	this.label2.Text = "Ilość wyświetlaczy 7-LED:";
        	// 
        	// label1
        	// 
        	...
        	this.Name = "AddEditLEDDisplayDeviceDialog";
        	this.ShowIcon = false;
