...
{
    partial class AddEditLCDDevice
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
        	...
        	// rows
        	// 
        	this.rows.HeaderText = "Wierszy";
        	this.rows.Name = "rows";
        	this.rows.SortMode = System.Windows.Forms.DataGridViewColumnSortMode.NotSortable;
        	this.rows.Width = 50;
        	// 
        	// cols
        	// 
        	this.cols.HeaderText = "Kolumn";
        	this.cols.Name = "cols";
        	...
        	this.label2.Text = "Ilość wyświetlaczy:";
        	// 
        	// label1
        	// 
