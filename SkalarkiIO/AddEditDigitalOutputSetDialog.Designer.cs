...
{
	partial class AddEditDigitalOutputSetDialog
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.groupBox1.Text = "Grupa wyjść cyfrowych";
			// 
			// groupBox2
			// 
			...
			this.Name = "AddEditDigitalOutputSetDialog";
			this.ShowIcon = false;
