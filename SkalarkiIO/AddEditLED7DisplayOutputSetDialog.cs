...
{
	/// <summary>
	/// Description of AddEditLED7DisplayOutputSetDialog.
	/// </summary>
	partial class AddEditLED7DisplayOutputSetDialog : Form
	{
		private class Output
		{
			public LED7DisplayOutput DO
			{
				get;
				set;
			}
		...
		public LED7DisplayOutputSet LED7DisplayOutputSet
		{
			get;
			private set;
		}
